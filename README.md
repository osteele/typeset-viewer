...
> This repository hosts the app's **releases, website, and issue tracker**. Typeset Preview is free but closed-source; the application source is not included here.

<!-- Add a screenshot: ![Typeset Preview](site/assets/screenshot-main.png) -->

## Install

1. Download the latest `.zip` from [Releases](https://github.com/osteele/typeset-preview/releases/latest).
2. Unzip and drag **Typeset Preview** to your Applications folder.
...
Typeset Preview updates itself using [Sparkle](https://sparkle-project.org). Use **Check for Updates…** in the app menu, or let it check on its own.
...
Typeset Preview is proprietary freeware. See [LICENSE](LICENSE). It bundles third-party tools under their own licenses, including Typst (Apache-2.0).
